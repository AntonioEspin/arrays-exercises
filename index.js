...
const filteresInventors = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1599)
console.log(filteresInventors)
...
const birthdateInventors = inventors.sort((a,b)=> a.year - b.year)
console.log(birthdateInventors)
...
const orderedLastName = people.sort((a,b)=> {
...
console.log(orderedLastName)

// 8. Reduce Exercise
// Sum up the instances of each of these
const data = ['car', 'car', 'truck', 'truck', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car', 'truck'];

const reduceInfo = data.reduce((acum, value)=> {
